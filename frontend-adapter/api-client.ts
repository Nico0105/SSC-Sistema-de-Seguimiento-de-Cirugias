/**
 * Cliente HTTP para el backend SSC (Express + Prisma).
 * Reemplaza a @/integrations/supabase/client.
 *
 * Copiar a: src/lib/api-client.ts en el frontend.
 */
...
// Socket.io singleton para tiempo real
